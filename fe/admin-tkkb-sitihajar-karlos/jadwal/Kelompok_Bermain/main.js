...
const jadwalHariData = [
  { hari: "Senin — Kamis", jam: "07:15 - 10:00" },
];

const jadwalBermainData = [
  { ikon: "/user.png", deskripsi: "Setiap hari ananda wajib membawa air minum (bukan susu kotak atau minuman dalam kemasan)." },
  { ikon: "/user.png", deskripsi: "Hari senin & rabu mendapatkan kue dari sekolah." },
  ...
  { ikon: "/user.png", deskripsi: "Hari kamis ananda wajib membawa alat sholat untuk sholat bersama di sekolah." }
];
...
function renderTabelAB() {
  ...
  jadwalBermainData.forEach((item, index) => {
    ...
    btnEdit.addEventListener("click", () => {
      if (editingIndexBermain !== null) return alert("Selesaikan edit lain dulu!");
      ...
      tr.querySelector(".btn-simpan").addEventListener("click", () => {
        ...
        jadwalBermainData[index] = { ikon: newIcon, deskripsi };
    ...
    btnHapus.addEventListener("click", () => {
      if (editingIndexBermain !== null) return alert("Selesaikan edit lain dulu!");
      if (confirm("Yakin ingin menghapus?")) {
        jadwalBermainData.splice(index, 1);
        renderTabelAB();
      }
    });
  });
...
document.getElementById("btnTambah").addEventListener("click", () => {
  if (editingIndexBermain !== null) return alert("Selesaikan edit terlebih dahulu.");
  editingIndexBermain = jadwalBermainData.length;
  ...
  tr.querySelector(".btn-simpan").addEventListener("click", () => {
    ...
    if (!deskripsi || !newIcon) return alert("Data boleh kosong!");
    jadwalBermainData.push({ ikon: newIcon, deskripsi });
    editingIndexBermain = null;
    renderTabelAB();
    enableAllButtons();
  });
