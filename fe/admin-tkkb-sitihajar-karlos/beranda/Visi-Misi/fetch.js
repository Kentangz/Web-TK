export function getAllVisi() {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/visi`)
    .then(response => {
      if (!response.ok) throw new Error(`Gagal memuat data visi. Status: ${response.status}`);
...
export function getVisiById(id) {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/visi/${id}`)
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal mengambil data visi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function postVisi({ visi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/visi`, {
    ...
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal menambahkan data visi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function updateVisiById(id, { visi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/visi/${id}`, {
    ...
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal memperbarui data visi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function deleteVisiById(id) {
  ...
  .then(response => {
    if (!response.ok) throw new Error(`Gagal menghapus data visi. Status: ${response.status}`);
    return response.json();
  })
  .catch(error => {
...
export function getAllMisi() {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/misi`)
    .then(response => {
      if (!response.ok) throw new Error(`Gagal memuat data misi. Status: ${response.status}`);
      return response.json();
    })
    .then(result => {
...
export function getMisiById(id) {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/misi/${id}`)
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal mengambil data misi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function postMisi({ misi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/misi`, {
    ...
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal menambahkan data misi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function updateMisiById(id, { misi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/misi/${id}`, {
    ...
    .then(response => {
      if (!response.ok) {
        throw new Error(`Gagal memperbarui data misi. Status: ${response.status}`);
      }
      return response.json();
    })
    .then(result => {
...
export function deleteMisiById(id) {
  ...
  .then(response => {
    if (!response.ok) throw new Error(`Gagal menghapus data misi. Status: ${response.status}`);
    return response.json();
  })
  .catch(error => {
