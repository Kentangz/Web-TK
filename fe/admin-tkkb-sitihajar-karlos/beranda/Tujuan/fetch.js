...
export function postTujuan({ tujuan_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/tujuan`, {
		...
		.then((response) => {
			if (!response.ok) {
				throw new Error(
					`Gagal menambahkan data tujuan. Status: ${response.status}`
				);
			}
			return response.json();
		})
...
export function updateTujuanById(id, { tujuan_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/tujuan/${id}`, {
		...
		.then((response) => {
			if (!response.ok) {
				throw new Error(
					`Gagal memperbarui data tujuan. Status: ${response.status}`
				);
			}
			return response.json();
		})
...
export function deleteTujuanById(id) {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/tujuan/${id}`, {
		...
		.then((response) => {
			if (!response.ok)
				throw new Error(
					`Gagal menghapus data tujuan. Status: ${response.status}`
				);
			return response.json();
		})
		.catch((error) => {
...
export function postStrategi({ strategi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/strategi`, {
		...
		.then((response) => {
			if (!response.ok) {
				throw new Error(
					`Gagal menambahkan data strategi. Status: ${response.status}`
				);
			}
			return response.json();
		})
...
export function updateStrategiById(id, { strategi_description }) {
  ...
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/strategi/${id}`, {
		...
		.then((response) => {
			if (!response.ok) {
				throw new Error(
					`Gagal memperbarui data strategi. Status: ${response.status}`
				);
			}
			return response.json();
		})
...
export function deleteStrategiById(id) {
  return fetch(`${import.meta.env.VITE_API_KEY}/beranda/strategi/${id}`, {
		...
		.then((response) => {
			if (!response.ok)
				throw new Error(
					`Gagal menghapus data strategi. Status: ${response.status}`
				);
			return response.json();
		})
		.catch((error) => {
